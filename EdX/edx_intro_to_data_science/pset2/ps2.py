...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        self.width=width
        self.height=height
        self.positions= [[False for col in range(width)] for row in range(height)]
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        self.positions[int(pos.getY())][int(pos.getX())]=True
    ...
    def getNumCleanedTiles(self):
        ...
        returns: an integer
        """
        return sum([sum(x) for x in self.positions])
    ...
    def getRandomPosition(self):
        ...
        """
        ranX=random.uniform(0,self.width)
        ranY=random.uniform(0,self.height)
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        self.speed=speed
        self.room=room
        randompos=room.getRandomPosition()
        self.pos=Position(randompos.getX(),randompos.getY())
