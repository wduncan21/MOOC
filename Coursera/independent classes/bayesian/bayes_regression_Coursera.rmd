...
To obtain the predictive distribution for $y_5$, we can first simulate $\sigma^2$ from its posterior and then $\mu$ followed by $y_5$.  Our draws of $y_5$ will be from the posterior predictive distribution.  The example below draws 100,000 times from the posterior predictive distribution of $y_5$.
